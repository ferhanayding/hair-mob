        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold">Elite Hair</h3>
                <p className="text-sm text-emerald-400">Clinic</p>
              </div>
            </div>
            <p
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#before-after" className="text-gray-400 hover:text-emerald-400 transition-colors">
                  {tNav('beforeAfter')}
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <a href="tel:+905551234567" className="text-gray-400 hover:text-emerald-400 transition-colors">
                    +90 555 123 45 67
                  </a>
                </div>
              </li>
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <a href="mailto:info@elitehairclinic.com" className="text-gray-400 hover:text-emerald-400 transition-colors break-all">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-6 inline-flex items-center space-x-2 gradient-primary text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all"
            >
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {currentYear} Elite Hair Clinic. {t('rights')}
            </p>
